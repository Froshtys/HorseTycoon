namespace HorseOverhaul
{
    ...
    namespace HorseTycoon
    {
        ...
        // https://github.com/Goldenrevolver/Stardew-Valley-Mods/blob/master/Stardew-Valley-Mods/HorseOverhaul/Patches/ThinHorsePatches.cs
        public class ThinHorsePatches
        {
            ...
            {
                if (ThinHorse && __instance is Horse)
                {
                    __result = 16;
                }
            }
